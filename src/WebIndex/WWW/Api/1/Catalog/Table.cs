...
namespace WebExpress.Tutorial.WebIndex.WWW.Api._1.Catalog
{
    ...
    [Cache]
    public sealed class Table : RestApiTable<Model.CatalogItem>
    {
        ...
        /// </param>
        public override IEnumerable<RestApiOption> GetOptions(IRequest request, Model.CatalogItem row)
        {
        ...
        /// </returns>
        public override IUri GetRestApiForInlineEdit(IRequest request, Model.CatalogItem row)
        {
        ...
        /// </returns>
        public override IEnumerable<Model.CatalogItem> GetData(string filter, IRequest request)
        {
            var data = Model.ViewModel.Catalog;
